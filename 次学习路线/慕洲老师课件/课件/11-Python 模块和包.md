# 12-Python 模块和包			![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/4975/1653721713077/dfa843190df541a3885ddcf46379390e.jpg)
...
当解释器遇到 import 语句，如果模块在当前的搜索路径就会被导入。调用的时候使用 `&#x3c;span>模块名.函数名&#x3c;/span>` 来进行调用
...
包路径下必须存在 `&#x3c;span>__init__.py&#x3c;/span>` 文件。
...
比如我们在 do.py 中导入 `&#x3c;span>calculator.py&#x3c;/span>`
...
但是导入调用的时候报名比较长，这样就可以使用 `&#x3c;span>from ... import ...&#x3c;/span>`语句来简化一下。
